...
public class SubmitTests
{
	...
	{
		//TODO: separate this if possible from this other test
		testGoodSubmittal();
		verifyPage.clickPrevious();
		assertTrue(Automation.getPageTitle().equals ("Tell us a little about your issue:"));
	}
	
	@Test
	public static void verifyFieldLengthsOnVerifyPage()
	{
		//TODO: separate this if possible from this other test
		testGoodSubmittal();
		
		assertTrue(verifyPage.verifyStandardFieldLengths("-------010-------020-------030-------040-------050-------060-------070-------080-------090-------100-------110-------120-------130-------140-------150-------160-------170-------180-------190-------200-------210-------220-------230-------240-------250-------260-------270-------280-------290-------300"));
	}
